...
@ComponentScan("ru.nsu.protasov")
@PropertySource("classpath:app.properties")
@EnableJpaRepositories("ru.nsu.protasov.repository")
public class DataConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUsername(UserParams.getUser());
        dataSource.setPassword(UserParams.getPassword());
